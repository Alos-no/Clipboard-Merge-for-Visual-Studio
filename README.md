<table>
  <tr>
    <td width="128" align="center">
      <img src="https://github.com/Alos-no/Clipboard-Merge-for-Visual-Studio/blob/main/src/Resources/icon.png?raw=true" alt="Extension icon">
    </td>
    <td>
...
This project is a C#/.NET port of my [original TypeScript extension for VS Code](https://github.com/Alos-no/Clipboard-Merge-for-Visual-Studio-Code).
...
![Extension Demo Preview](https://github.com/Alos-no/Clipboard-Merge-for-Visual-Studio/blob/main/src/Resources/preview.png?raw=true)
...
- 🎯 **Selection Support:** Compare just a selected region of code instead of the entire document.
...
### 3. Compare Mode
Choose what content to compare against the clipboard:
- **Document** *(default)* — Compare the entire active document with the clipboard.
- **Selection** — Compare only the selected text with the clipboard. Shows an error if nothing is selected.
- **SelectionOrDocument** — Compare the selection if text is selected, otherwise fall back to the entire document.
